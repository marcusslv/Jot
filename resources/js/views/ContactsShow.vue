        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div class="relative">
                    ...
                    <a href="#" @click.prevent="modal = !modal" class="px-4 py-2 rounded text-red-500 border border-red-500 text-sm font-bold">Delete</a>

                    <div v-if="modal" class="absolute bg-blue-900 text-white rounded-lg z-20 p-8 w-64 right-0 mt-2 mr-6">
                        <p>Are you sure you want to delete this record?</p>
                        <div class="flex items-center mt-6 justify-end">
                            <button class="text-white pr-4" @click.prevent="modal = !modal">Cancel</button>
    ...
    methods: {
        destroy: function () {
            axios.delete('/api/contacts/' + this.$route.params.id)
                ...
                .catch(error => {
                    alert('Internal Erro. Unable to delete contact.')
                });
        }
    }
}
